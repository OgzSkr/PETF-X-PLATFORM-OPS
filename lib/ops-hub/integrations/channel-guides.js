export const INTEGRATION_CHANNEL_META = Object.freeze({
  ...
  getir: {
    ...
    fields: [
      { key: 'shopId', label: 'İşletme / Shop ID', type: 'text' },
      { key: 'webhookSecret', label: 'x-api-key (webhook)', type: 'password' }
    ],
    steps: [
      'GetirCarsiAPI başvuru formunu doldurun: iki webhook URL + x-api-key.',
      'Getir panelinden işletme (shop) ID\'nizi alın ve forma kaydedin.',
      'Canlı DNS aktif olunca Getir test POST\'ları webhook\'lara ulaşır.',
      'Supplier API credential gelene kadar kanal shadow modunda bekler.'
    ],
    prerequisite:
