  ...
  const bodyHtml = `
    ...
    <section class="ops-section" id="shadowReadinessSection">
      ...
      <p style="margin-top:12px">
        <a href="/marketnext/matching" class="ops-btn ops-btn-secondary" style="display:inline-flex;text-decoration:none;margin-right:8px">Ürün Eşleştirme</a>
        <a href="/marketnext/health" class="ops-btn ops-btn-ghost-sm" style="display:inline-flex;text-decoration:none">Sistem durumu</a>
      </p>
    </section>
    ...
    <div class="ops-detail-grid">
      <section class="ops-section">
        ...
        <p style="margin-top:12px"><a href="/marketnext/picking" class="ops-btn ops-btn-primary" style="display:inline-flex;text-decoration:none">Toplama kuyruğuna git</a></p>
      </section>

      <section class="ops-section">
        <h3>Kanal durumu</h3>
        <div id="channelSummary" class="ops-health-grid"></div>
        <p style="margin-top:12px"><a href="/marketnext/integrations" class="ops-btn ops-btn-secondary" style="display:inline-flex;text-decoration:none">Kanalları yönet</a></p>
      </section>
    </div>`;
