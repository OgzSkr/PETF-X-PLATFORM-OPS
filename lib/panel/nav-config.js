...
export const PANEL_MODULES = {
  marketnext: {
    ...
    label: 'MarketNext',
    items: [
      { id: 'dashboard', href: '/marketnext', label: 'Dashboard', icon: 'mn-dashboard', aliases: ['/quick-commerce', '/dashboard'] },
      { id: 'orders', href: '/marketnext/orders', label: 'Siparişler', icon: 'mn-orders', aliases: ['/quick-commerce/orders'] },
      ...
      { id: 'getir', href: '/marketnext/orders/getir', label: 'Getir', icon: 'channel-getir', aliases: ['/getir'] },
      ...
      { id: 'sync', href: '/marketnext/sync', label: 'Stok & Fiyat', icon: 'mn-sync' },
