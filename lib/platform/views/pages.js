...
import { renderTrendyolSubNav, renderMarketNextProfitPage as renderMarketNextProfitPageView } from './nav.js';
...
export function createPageViews(auth, runtimeConfig = {}) {
      ...
      <div class="products-wrap pf-marketplace-content">
        ...
        <section class="settings-card">
          <div class="settings-head">
            ...
            <p class="platform-lead">BuyBox ve Trendyol sipariş kârlılığı bu maliyet setini kullanır. Diğer kanallar için <a href="/products/mappings">Ürün Merkezi → Kanal Eşleşmeleri</a> sayfasını kullanın.</p>
  ...
  return wrapPanelPage({
    ...
    bodyHtml: innerHtml,
    stylesheets: ['/assets/styles.css', '/assets/products.css'],
    scripts: ['/assets/products.js?v=3']
  });
}
  ...
  const innerHtml = `
      ...
      <div class="orders-wrap pf-marketplace-content">
        <section class="panel orders-intro">
          ...
          <p class="platform-lead">Trendyol Pazaryeri siparişlerinin net kâr analizi. Maliyetler <a href="/marketplace/products">Ürün Ayarları</a> ve onaylı eşleştirmeler (<a href="/products?tab=trendyol-marketplace">Ürün Merkezi</a>) üzerinden hesaplanır.</p>
  ...
  return wrapPanelPage({
    ...
    bodyHtml: innerHtml,
    stylesheets: ['/assets/styles.css', '/assets/orders.css'],
    scripts: ['/assets/channel-page.js?v=2', '/assets/orders.js?v=8']
  });
  }
  ...
  function renderMarketNextProfitPage() {
    return renderMarketNextProfitPageView({
      auth,
