      ...
      <div class="products-wrap pf-marketplace-content">
        ...
        <section class="settings-card">
          <div class="settings-head">
            ...
            <p class="platform-lead">BuyBox ve Trendyol sipariş kârlılığı bu maliyet setini kullanır. Diğer kanallar için <a href="/marketnext/matching/mappings">Eşleştirme Merkezi → Kanal Eşleşmeleri</a> sayfasını kullanın.</p>
  ...
  const innerHtml = `
      ...
      <div class="orders-wrap pf-marketplace-content">
        <section class="panel orders-intro">
          ...
          <p class="platform-lead">Trendyol Pazaryeri siparişlerinin net kâr analizi. Maliyetler <a href="/marketplace/products">Ürün Ayarları</a> ve onaylı eşleştirmeler (<a href="/marketnext/matching?tab=trendyol-marketplace">Eşleştirme Merkezi</a>) üzerinden hesaplanır.</p>
